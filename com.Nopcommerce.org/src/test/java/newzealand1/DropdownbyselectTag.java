...
public class DropdownbyselectTag {
	...
	Select selection = new Select(manufacture);
	

	Thread.sleep(3000);
   
	List<WebElement> se = selection.getOptions();
  for(int i=0;i<=se.size();i++) {
	if(i==2) {
		se.get(i).click();
		System.out.println(se.get(i).getText()); 
...
//   System.out.println(se);
	...
	// selection.selectByVisibleText("Nike");
