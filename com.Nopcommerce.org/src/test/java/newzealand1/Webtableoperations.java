...
//
//String val = driver.findElement(By.xpath("//table[@id='products-grid']/tbody/tr[" + i + "]/td[" + j + "]")).getText();
//		
//System.out.print(val + "	");
//
//			if (i == 2 && j == 1) {
//					Thread.sleep(3000);
//					driver.findElement(By.xpath("//table[@id='products-grid']/tbody/tr[" + i + "]/td[" + j + "]")).click();
//					Thread.sleep(3000);
